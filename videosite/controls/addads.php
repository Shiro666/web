...
if($_POST){
    ...
    move_uploaded_file($_FILES['thumb']['tmp_name'], '../' . $thumb);
 	...
 	$sql = 'INSERT INTO ads(title,link_url,image_url,intro,
 	status,created) VALUES("'.$_POST['title'].'","'.$_POST['link_url'].'",
 	"'.$thumb.'","'.$_POST['intro'].'",1,'.time().');';
						...
						<div class="col-xs-12">
							...
							<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post">
                                 <div class="form-group">
									...
									<div class="col-sm-9">
										<input name="link_url" type="text" id="form-field-1" required="" placeholder="" class="col-xs-10 col-sm-5" />
									</div>
								</div> <div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                        图片地址
